...
<html i18n-values="
    ...
    bookmarkbarattached:bookmarkbarattached;" class="" dir="ltr" hasattribution="false" themegravity="" bookmarkbarattached="false"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta charset="utf-8">
...
.recent-window {
  background-image: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAQAAAC1+jfqAAAAL0lEQVQokWM4cfjEfzzwMANeaSAEK4CBE/+fQSGKAmSAqQRNAToYVUBNBfij+wgAQxDqTSvyVa0AAAAASUVORK5CYII=');
}
...
<link id="themecss" rel="stylesheet" href="chrome://theme/css/new_tab_theme.css?1379351281042">
...
<style type="text/css">.dot { max-width: 80px; }</style></head>

<body i18n-values=".style.fontFamily:fontfamily;.style.fontSize:fontsize" style="font-family: Ubuntu, Arial, sans-serif; font-size: 75%;">
  ...
  <div id="card-slider-frame" class="showing-login-area">
    <button id="page-switcher-start" class="page-switcher custom-appearance" tabindex="2" style="width: 31px; left: 0px; top: 0px; padding-bottom: 0px;" aria-label="Go to Most visited">‹
    </button>
    <div id="page-list" style="-webkit-transform: translate3d(-1272px, 0, 0);"><div class="tile-page most-visited-page animating-tile-page" style="width: 1272px;" aria-hidden="true"><div class="tile-page-scrollbar" hidden=""></div><div class="tile-page-content"><div class="top-margin" style="margin-top: 67px;"></div><div class="tile-grid" role="menu" aria-label="Use left and right arrow keys to navigate." style="min-width: 259.25px; min-height: 589px; height: 383.5px;"><div class="tile real" style="left: 0px; right: 0px; top: 0px;"><a class="most-visited real focusable" tabindex="-1" title="Facebook" style="width: 214px; height: 165px; left: 75px; right: 75px; top: 0px;" id="most-visited-tile-8" href="http://facebook.com/"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://facebook.com/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://facebook.com/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(72, 98, 163);"></div><span class="title" dir="ltr">Facebook</span></a></div><div class="tile real" style="left: 137px; right: 137px; top: 0px;"><a class="most-visited real focusable" tabindex="-1" title="YouTube" style="width: 214px; height: 165px; left: 178px; right: 178px; top: 0px;" id="most-visited-tile-9" href="http://www.youtube.com/"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://www.youtube.com/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://www.youtube.com/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(147, 13, 8);"></div><span class="title" dir="ltr">YouTube</span></a></div><div class="tile real" style="left: 275px; right: 275px; top: 0px;"><a class="most-visited real focusable" tabindex="-1" title="Bootstrap" style="width: 214px; height: 165px; left: 282px; right: 282px; top: 0px;" id="most-visited-tile-10" href="http://getbootstrap.com/"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://getbootstrap.com/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://getbootstrap.com/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(48, 30, 83);"></div><span class="title" dir="ltr">Bootstrap</span></a></div><div class="tile real" style="left: 412px; right: 412px; top: 0px;"><a class="most-visited real focusable" tabindex="-1" title="jQuery Mobile | jQuery Mobile" style="width: 214px; height: 165px; left: 385px; right: 385px; top: 0px;" id="most-visited-tile-11" href="http://jquerymobile.com/"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://jquerymobile.com/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://jquerymobile.com/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(70, 168, 210);"></div><span class="title" dir="ltr">jQuery Mobile | jQuery Mobile</span></a></div><div class="tile real" style="left: 0px; right: 0px; top: 123px;"><a class="most-visited real focusable" tabindex="-1" title="LT | Filmstrip visualization" style="width: 214px; height: 165px; left: 75px; right: 75px; top: 69px;" id="most-visited-tile-12" href="http://localhost:3000/"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://localhost:3000/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://localhost:3000/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(145, 145, 145);"></div><span class="title" dir="ltr">LT | Filmstrip visualization</span></a></div><div class="tile real" style="left: 137px; right: 137px; top: 123px;"><a class="most-visited real focusable" tabindex="-1" title="Send Money, Pay Online and Merchant Accounts - PayPal India" style="width: 214px; height: 165px; left: 178px; right: 178px; top: 69px;" id="most-visited-tile-13" href="http://www.paypal.com/"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://www.paypal.com/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://www.paypal.com/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(0, 50, 101);"></div><span class="title" dir="ltr">Send Money, Pay Online and Merchant Accounts - PayPal India</span></a></div><div class="tile real" style="left: 275px; right: 275px; top: 123px;"><a class="most-visited real focusable" tabindex="-1" title="Index of /three_js_test" style="width: 214px; height: 165px; left: 282px; right: 282px; top: 69px;" id="most-visited-tile-14" href="http://192.168.1.129/three_js_test/"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://192.168.1.129/three_js_test/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://192.168.1.129/three_js_test/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(145, 145, 145);"></div><span class="title" dir="ltr">Index of /three_js_test</span></a></div><div class="tile real" style="left: 412px; right: 412px; top: 123px;"><a class="most-visited real focusable" tabindex="-1" title="Gaana.com Listen to Songs Online: Listen to Free Music Online" id="most-visited-tile-15" href="http://gaana.com/" style="width: 214px; height: 165px; left: 385px; right: 385px; top: 69px;"><span class="thumbnail-wrapper fills-parent"><div class="close-button" title="Don&#39;t show on this page"></div><span class="thumbnail fills-parent" style="background-image: url(chrome://thumb/http://gaana.com/);"><div class="thumbnail-shield fills-parent"></div></span><span class="favicon" style="background-image: -webkit-image-set(url(chrome://favicon/size/16@1x/http://gaana.com/) 1x);"></span></span><div class="color-stripe" style="background-color: rgb(145, 145, 145);"></div><span class="title" dir="ltr">Gaana.com Listen to Songs Online: Listen to Free Music Online</span></a></div></div></div></div><div class="tile-page apps-page selected-card animating-tile-page" style="width: 1272px;"><div class="tile-page-scrollbar" hidden=""></div><div class="tile-page-content"><div class="top-margin" style="margin-top: 76px;"></div><div class="tile-grid" role="menu" aria-label="Use left and right arrow keys to navigate." style="min-width: 260px; min-height: 580px; height: 356.60377358490564px;"><div class="tile real" style="left: 0px; right: 0px; top: 0px;"><div id="ahfgeienlihckogmohjhadlkjgocpleb" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 18px; right: 18px; top: 0px;" tabindex="1"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Store" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/ahfgeienlihckogmohjhadlkjgocpleb/128/1">
  </div>
  <span class="title launch-click-target" title="Store">Store</span>
</div></div></div><div class="tile real" style="left: 90px; right: 90px; top: 0px;"><div id="pjkljhegncpnkpknbcohdijeoejaedia" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 106px; right: 106px; top: 0px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Gmail" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/pjkljhegncpnkpknbcohdijeoejaedia/128/1">
  </div>
  <span class="title launch-click-target" title="Gmail">Gmail</span>
</div></div></div><div class="tile real" style="left: 180px; right: 180px; top: 0px;"><div id="blpcfgokakmgnkcojhhkbfbldkacnbeo" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 195px; right: 195px; top: 0px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="YouTube" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/blpcfgokakmgnkcojhhkbfbldkacnbeo/128/1">
  </div>
  <span class="title launch-click-target" title="YouTube">YouTube</span>
</div></div></div><div class="tile real" style="left: 270px; right: 270px; top: 0px;"><div id="aohghmighlieiainnegkcijnfilokake" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 283px; right: 283px; top: 0px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Google Docs" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/aohghmighlieiainnegkcijnfilokake/128/1">
  </div>
  <span class="title launch-click-target" title="Google Docs">Google Docs</span>
</div></div></div><div class="tile real" style="left: 360px; right: 360px; top: 0px;"><div id="coobgpohoikkiipiblmjeljniedjpjpf" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 371px; right: 371px; top: 0px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Google Search" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/coobgpohoikkiipiblmjeljniedjpjpf/128/1">
  </div>
  <span class="title launch-click-target" title="Google Search">Google Search</span>
</div></div></div><div class="tile real" style="left: 450px; right: 450px; top: 0px;"><div id="hbdpomandigafcibbmofojjchbcdagbl" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 460px; right: 460px; top: 0px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="TweetDeck by Twitter" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/hbdpomandigafcibbmofojjchbcdagbl/128/1">
  </div>
  <span class="title launch-click-target" title="TweetDeck by Twitter">TweetDeck by Twitter</span>
</div></div></div><div class="tile real" style="left: 0px; right: 0px; top: 90px;"><div id="apdfllckaahabafndbhieahigkjlhalf" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 18px; right: 18px; top: 88px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Google Drive" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/apdfllckaahabafndbhieahigkjlhalf/128/1">
  </div>
  <span class="title launch-click-target" title="Google Drive">Google Drive</span>
</div></div></div><div class="tile real" style="left: 90px; right: 90px; top: 90px;"><div id="decdfngdidijkdjgbknlnepdljfaepji" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 106px; right: 106px; top: 88px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Read Later Fast" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/decdfngdidijkdjgbknlnepdljfaepji/128/1">
  </div>
  <span class="title launch-click-target" title="Read Later Fast">Read Later Fast</span>
</div></div></div><div class="tile real" style="left: 180px; right: 180px; top: 90px;"><div id="ejjicmeblgpmajnghnpcppodonldlgfn" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 195px; right: 195px; top: 88px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Google Calendar" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/ejjicmeblgpmajnghnpcppodonldlgfn/128/1">
  </div>
  <span class="title launch-click-target" title="Google Calendar">Google Calendar</span>
</div></div></div><div class="tile real" style="left: 270px; right: 270px; top: 90px;"><div id="ejidjjhkpiempkbhmpbfngldlkglhimk" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 283px; right: 283px; top: 88px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="Gmail Offline" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/ejidjjhkpiempkbhmpbfngldlkglhimk/128/1">
  </div>
  <span class="title launch-click-target" title="Gmail Offline">Gmail Offline</span>
</div></div></div><div class="tile real" style="left: 360px; right: 360px; top: 90px;"><div id="lhkmoheomjbkfloacpgllgjcamhihfaj" role="menuitem" class="app focusable" style="height: 158px; width: 158px; left: 371px; right: 371px; top: 88px;"><div id="" class="app-contents">
  <div class="app-img-container launch-click-target" aria-hidden="true" title="JSON Editor" style="height: 127px; width: 127px;">
    <img class="" alt="" src="chrome://extension-icon/lhkmoheomjbkfloacpgllgjcamhihfaj/128/1">
  </div>
  <span class="title launch-click-target" title="JSON Editor">JSON Editor</span>
</div></div></div></div></div></div></div>
    <button id="page-switcher-end" class="page-switcher custom-appearance" tabindex="2" style="width: 31px; right: 0px; top: 0px; padding-bottom: 0px;" aria-label="" hidden="">›
    </button>
    <div id="attribution" hidden="">
      <span i18n-content="attributionintro">Theme created by</span>
      <img id="attribution-img">
    </div>
  </div>

  <div id="app-launcher-promo" hidden="">
    <div class="apps-promo-text" i18n-content="appsPromoTitle">Discover the Chrome App Launcher</div>
    <a href="https://chrome.google.com/webstore/launcher" class="apps-promo-learn-more" i18n-content="learn_more">Learn more</a>
    <img src="data:image/png;base64,">
    <button class="close-button custom-appearance" id="app-launcher-promo-close-button">
    </button>
  </div>
  ...
  <div id="footer">
    ...
    <div id="footer-content">
      <div id="logo-img" style="flex: 0 1 347px;">
        <img alt="" src="chrome://theme/IDR_PRODUCT_LOGO">
        <div id="promo-bubble-anchor"></div>
      </div>

      <ul id="dot-list">
      <li class="dot" role="button" title="Most visited" tabindex="3"><div class="selection-bar"></div><input spellcheck="false" disabled=""></li><li class="dot selected" role="button" title="Apps"><div class="selection-bar"></div><input spellcheck="false" disabled=""></li></ul>

      <div id="footer-menu-container" class="menu-container" style="flex: 0 1 347px;">
        <button id="other-sessions-menu-button" class="footer-menu-button custom-appearance menu-button">
          <span i18n-content="otherSessions">Other devices</span>
          <div class="disclosure-triangle"></div>
        </button>
        <button id="recently-closed-menu-button" class="footer-menu-button custom-appearance menu-button">
          <span i18n-content="recentlyclosed">Recently closed</span>
          <div class="disclosure-triangle"></div>
        </button>
        <a id="chrome-web-store-link" href="https://chrome.google.com/webstore?hl=en-US&utm_source=chrome-ntp-launcher">
          <span id="chrome-web-store-title" i18n-content="webStoreTitleShort">Web Store</span>
        </a>
      ...
      <div id="trash" class="trash">
        <span class="lid"></span>
        <span class="can"></span>
        <span class="trash-text" i18n-content="appuninstall">Remove from Chrome</span>
      </div>
    </div>
  </div>

  <button id="login-container" class="custom-appearance">
    <div id="login-status-header-container" class="login-status-row" style="background-image: none;">
      <div id="login-status-header"><span class="profile-name">sgaurav.baghel@gmail.com</span></div>
    </div>
...
<div id="login-status-bubble-contents">
  <div id="login-status-message-container">
    ...
    <a id="login-status-learn-more" i18n-content="learn_more" i18n-values="href:login_status_url" target="_blank" href="">Learn more</a>
  </div>
  <div class="login-status-row">
    <div id="login-status-advanced-container">
      <a id="login-status-advanced" i18n-content="login_status_advanced" href="chrome://newtab/#"></a>
    </div>
    <button id="login-status-dismiss" i18n-content="login_status_dismiss"></button>
  </div>
</div>
...
<div id="other-sessions-promo-template" class="other-sessions-promo-message">
  <span i18n-content="otherSessionsEmpty">Access your open tabs on all of your devices.</span>
  <p>
    <a i18n-values="href:otherSessionsLearnMoreUrl" i18n-content="learnMore" href="http://support.google.com/chrome/bin/answer.py?answer=185277&hl=en">Learn more</a>
  </p>
</div>
...
</script><menu class="decorated footer-menu" role="menu" hidden=""></menu><menu class="decorated footer-menu" role="menu" hidden=""><div class="other-sessions-promo-message">
  <span i18n-content="otherSessionsEmpty">Access your open tabs on all of your devices.</span>
  <p>
    <a i18n-values="href:otherSessionsLearnMoreUrl" i18n-content="learnMore" href="http://support.google.com/chrome/bin/answer.py?answer=185277&hl=en">Learn more</a>
  </p>
</div><section><h3 class="session-heading">Ubuntu 12.10<button tabindex="-1" class="custom-appearance menu-button drop-down"></button><span class="details">6 hours ago</span></h3><div><a class="footer-menu-item custom-appearance" href="chrome-extension://mmfklpmdfldnnjbkdmamhokiphfkfieg/main.html" role="menuitem" style="background-image: -webkit-image-set(url(chrome://session-favicon/size/16@1x/chrome-extension://mmfklpmdfldnnjbkdmamhokiphfkfieg/main.html) 1x);">Sticky Notes</a><a class="footer-menu-item custom-appearance" href="http://www.youtube.com/watch?v=N3jnyKn1zZQ&list=PL39A101ABF5AD38B3" role="menuitem" style="background-image: -webkit-image-set(url(chrome://session-favicon/size/16@1x/http://www.youtube.com/watch?v=N3jnyKn1zZQ&amp;list=PL39A101ABF5AD38B3) 1x);">▶ Tum Mile ( O Meri Jaan ) - YouTube</a></div></section></menu><menu class="decorated device-context-menu footer-menu-context-menu" role="menu" hidden=""><button class="custom-appearance" role="menuitem">Collapse list</button><button class="custom-appearance" role="menuitem">Expand list</button><button class="custom-appearance" role="menuitem">Open all</button></menu></body></html>